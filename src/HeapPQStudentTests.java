...
public class HeapPQStudentTests {
    ...
    public void testResize() {
        ...
        assertEquals(15, ((MaxHeap<Integer>) maxHeap).getBackingArray().length);

        maxHeap.add(14 * 14 * 14 - 74);

        assertEquals(15, maxHeap.size());
        assertEquals(30, ((MaxHeap<Integer>) maxHeap).getBackingArray().length);
    }
}
